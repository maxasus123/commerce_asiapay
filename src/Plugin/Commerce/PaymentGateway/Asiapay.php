...
namespace Drupal\commerce_asiapay\Plugin\Commerce\PaymentGateway;
 ...
 *   id = "asiapay",
 *   label = "Asiapay",
 *   display_label = "Asiapay",
 *    forms = {
 *     "add-payment-method" = "Drupal\commerce_asiapay\PluginForm\Asiapay\PaymentMethodAddForm",
 *   },
 ...
 * )
 */
class Asiapay extends OnsitePaymentGatewayBase implements AsiapayInterface {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $form['secure_hash_secret'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Secure Hash Secret'),
      '#description' => $this->t('Optional. Your Secret Key from AsiaPay (PayDollar/PesoPay/SiamPay)'),
      '#required' => TRUE,
      '#default_value' => $this->configuration['secure_hash_secret'],
    ];
  ...
  public function submitConfigurationForm(array &$form, FormStateInterface $form_state) {
    ...
    if (!$form_state->getErrors()) {
      ...
      $this->configuration['secure_hash_secret'] = $values['secure_hash_secret'];
    }
  }
